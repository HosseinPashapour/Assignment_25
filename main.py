...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        font7seg = QFontDatabase.addApplicationFont("Seven Segment.ttf")
        ...
        for i in range(12):
                new_btn=QPushButton()
                new_btn.setText("❌")
                new_btn.setStyleSheet("background-color:  rgb(255, 255, 255);font: 700 12pt"+"Segoe UI;border-radius: 15px; ")
                
                new_btn_edit=QPushButton()
                new_btn_edit.setText("Edit")
                new_btn_edit.setStyleSheet("background-color: rgb(255, 255, 255);font: 700 12pt"+"Segoe UI;border-radius: 15px;")

                new_cell=QLineEdit()
                new_cell.setStyleSheet("font: 700 10pt "+"Segoe UI;color: rgb(0, 0, 0); ")
    ...
    def Edit_Alarm(self,alarm_data):
            ...
            msg_box = QMessageBox()
            msg_box.setText('❌ Please First Change data then click on Edit button ❌')
    ...
    def Del_alarm(self,command,alarm_data):
            ...
            if len(id)==0:
                msg_box = QMessageBox()
                msg_box.setText('👀 This Alarm does not exist!!! 😶‍🌫️')
